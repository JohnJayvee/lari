...
<form  method="POST" action="{{ route('ads.update') }}" id="adsForm">
  @csrf
  <input type="hidden" id="id" name="id" value="{{ $ads->adsid }}"/>
    <div class="modal-header ">
      <h5 class="modal-title" id="modalTopTitle"><i class="bx bx-pencil me-1"></i> Ads </h5>
    </div>
      ...
      <div class="row">
        <div class="col-12 mb-3">
          <div class="input-group">
            <input type="file" class="form-control" id="adsfilename" name="adsfilename" aria-describedby="Upload" aria-label="Upload" value=""  accept="image/jpeg, image/png, video/mp4">

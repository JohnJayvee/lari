<form  method="POST" action="{{ route('customers.update') }}" >
  ...
  <input type="hidden" id="id" name="id" value="{{ $customers->customerid }}"/>
    <div class="modal-header ">
      <h5 class="modal-title" id="modalTopTitle"><i class="bx bx-pencil me-1"></i> Customer </h5>
    </div>
    <div class="modal-body ">
      ...
      <div class="row">
        ...
        <div class="col-8 mb-3">
          <label for="LevelID" class="form-label "><strong>Plan</strong></label>
      ...
      <div class="row mb-5">
        <div class="col-4 mb-3">
          <label for="LevelID" class="form-label "><strong>Role</strong></label>
        ...
        <div class="col-8 mb-3">
          <label for="nameSlideTop" class="form-label"><strong>Address</strong></label>
          <input
            type="text"
            id="address"
            name="address"
